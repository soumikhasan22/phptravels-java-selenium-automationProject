...
public class AgentSignUp_Page {

    private WebDriver driver;
    private WebDriverWait wait;

    public AgentSignUp_Page(WebDriver driver,WebDriverWait wait)
    {
        this.driver=driver;
        this.wait=wait;
    }
    ...
    By agent_signUp=By.xpath("//span[@class='font-medium' and normalize-space()='Agent Signup']");

    By inner_agent_signUp=By.xpath("//a[contains(@class,'bg-white') and .//span[@class='material-symbols-outlined' " +
            "and normalize-space()='person_add']]");
    ...
    By successMsg = By.xpath("//p[contains(text(),'Registration successful! We are unable to send ver')]");
    By existAccountMsg = By.xpath("//div[@class='alert-error']//p[@class='text-sm']");

    //Actions

    public void navigateToAgentSignUp() {
        try {
            Thread.sleep(1000);
            ...
            System.out.println("✓ Agent Signup option selected successfully");
            wait.until(ExpectedConditions.elementToBeClickable(inner_agent_signUp)).click();
            System.out.println("✓ Successfully navigated to Agent Signup page");
        ...
        try {
            ...
            if (!driver.findElements(successMsg).isEmpty() &&
                ...
                if (successText.contains("Registration successful! Please check your email to verify your account.")) {
                    ...
                    System.out.println("✓ Agent registration Completed");
                }
            }
